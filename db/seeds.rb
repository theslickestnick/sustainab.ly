...
50.times do 
    RestaurantFood.create!(:food_type => Faker::Food.drish, :quantity => rand(20..50), :restaurant_id => Restaurant.all.sample.id, :use_by => Faker::Date.forward(days: 100), :notes => Faker::Lorem.paragraph)
end
