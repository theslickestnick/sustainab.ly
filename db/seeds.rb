...
50.times do 
    RestaurantFood.create!(:food_type => Faker::Food.dish, :quantity => rand(20..50), :restaurant_id => Restaurant.all.sample.id, :use_by => Faker::Date.forward(days: 100), :notes => Faker::Lorem.paragraph)
end
30.times do
