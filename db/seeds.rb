...
30.times do
    Organization.create(:name => Faker::Restaurant.name, :street_address => Faker::Address.street_address, :city => Faker::Address.city, :state => Faker::Address.state, :zip_code => Faker::Address.zip_code, :contact_email => Faker::Internet.email, :phone_number => Faker::PhoneNumber.phone_number)
 end
 5.times do
